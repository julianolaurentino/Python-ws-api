...
df = pd.read_json(r'D:\Users\Inked\Documents\JULIANO\workspace\VS Code\Python\Python-ws-api\base\data.json')
...
conn = sqlite3.connect(r'D:\Users\Inked\Documents\JULIANO\workspace\VS Code\Python\Python-ws-api\base\mercadolivre.db')
